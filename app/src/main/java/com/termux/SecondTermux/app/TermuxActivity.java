...
import com.termux.secondtermux.shared.activity.ActivityUtils;
...
import com.termux.secondtermux.shared.termux.extrakeys.ExtraKeysView;
import com.termux.secondtermux.shared.termux.interact.TextInputDialogUtils;
...
import com.termux.secondtermux.shared.view.ViewUtils;
                ...
                if(PermissionUtils.checkAndRequestLegacyOrManageExternalStoragePermission(
                    ...
                    if (isPermissionCallback)
                        Logger.logInfoAndShowToast(TermuxActivity.this, LOG_TAG,
                            getString(com.termux.secondtermux.shared.R.string.msg_storage_permission_granted_on_request));

                    TermuxInstaller.setupStorageSymlinks(TermuxActivity.this);
                } else {
                    if (isPermissionCallback)
                        Logger.logInfoAndShowToast(TermuxActivity.this, LOG_TAG,
                            getString(com.termux.secondtermux.shared.R.string.msg_storage_permission_not_granted_on_request));
                }
            }
        }.start();
    }
