package com.termux.secondtermux.shared.activities;
...
import com.termux.secondtermux.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.termux.secondtermux.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.termux.secondtermux.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
